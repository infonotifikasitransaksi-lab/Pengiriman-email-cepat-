...
// Exact official 1:1 Anthropic Claude spark vector path (kept for reference)
...
export const StarburstIcon: React.FC<StarburstIconProps> = React.memo(({
  ...
  const [src, setSrc] = useState("/claude.gif?v=3");
  ...
  return (
    <img
      ...
      alt="Claude AI"
      onError={() => {
        if (src !== "https://media1.tenor.com/m/zimAk6gPNIAAAAAC/claude.gif") {
          setSrc("https://media1.tenor.com/m/zimAk6gPNIAAAAAC/claude.gif");
        }
      }}
